...
exports.acceptInvitation = function(req, res) {
  ...
  // gameSockets.emit('cancelInv', {userId: userId});
  // gameSockets.emit('cancelInv', {userId: inviterId});
...
exports.cancelInvitation = function (req, res) {
  ...
  User.findById({_id:opponentId}, function(err, opponent) {
    ...
    console.log('cancelInvitation from', username, 'to', opponent.username);
    res.sendStatus(200);
  });
}
...
exports.refuseInvitation = function (req, res) {
  ...
  User.findById({_id:opponentId}, function(err, opponent) {
    ...
    console.log(username, 'refuse Invitation from', opponent.username);
    res.sendStatus(200);
  });
}
