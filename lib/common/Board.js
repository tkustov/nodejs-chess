...
function Board() {
  ...
  this.pieces = {
    ...
    'f2': new Pawn (this,'white', 'f2'),'e2': new Pawn (this,'white', 'e2'),
    'd2': new Pawn (this,'white', 'd2'),'c2': new Pawn (this,'white', 'c2'), 
    'b2': new Pawn (this,'white', 'b2'),'a2': new Pawn (this,'white', 'a2'),
    'a7': new Pawn (this,'black', 'a7'),'b7': new Pawn (this,'black', 'b7'),
    'c7': new Pawn (this,'black', 'c7'),'d7': new Pawn (this,'black', 'd7'),
    'e7': new Pawn (this,'black', 'e7'),'f7': new Pawn (this,'black', 'f7'),
    'g7': new Pawn (this,'black', 'g7'),'h7': new Pawn (this,'black', 'h7'),
...
Board.prototype = {
  move: function move(form, to) {
    ...
    if (posMoves.length == 0) return false;
    for (var i = 0; i < posMoves.length; i++) {
      if (posMoves[i] === to) {
         ...
         //console.log('game status', this.isGameStatus(color), ' for ',color);
         return true;
      }
    }
    return false;
 ...
 findKing: function findKing(color){
  ...
  tryMove: function tryMove (form, to) {
    var posMoves = this.getMoves(form);
    for (var i = 0; i < posMoves.length; i++) {
      if (posMoves[i] === to) {
         return true;
  ...
  getState: function () {
    ...
    for (piece in this.pieces) {
      ...
      curPiece.name = this.pieces[piece].constructor.name.toLowerCase();
